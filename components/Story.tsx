        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-1 md:gap-0 xl:mt-5 font-serif italic">
            <div className="md:p-8 lg:p-14 ">
              ...
              <p className="mt-5 mb-5 text-base text-gray-600 font-bold">
                We met 6 years ago and quickly became good friends. Our
                friendship evolved into love, but we were hesitant to express
                our feelings. When we finally did, it was heartbreaking to learn
                that she had started talking to someone and had to leave the
                country. Despite this, we stayed in each other's lives,
                providing comfort and support. Her move brought trust issues,
                communication gaps, and emotional distance. But every time we
                reconnected, it felt as though no time had passed.
              </p>
              ...
              <p
                data-aos="fade-up"
                className="mt-5 mb-5 text-base text-gray-600 font-bold"
              >
                Over the years, we both tried other relationships, but our
                hearts always led us back to each other. Nature conspired to
                reunite us, reaffirming that we were meant to be together.
                Exhausted from the cycle of separations and reconciliations, we
                decided to fully commit to each other.
              </p>
              ...
              <p
                ...
                className="mt-5 mb-5 text-base text-gray-600 font-bold"
              >
                “He Proposed | I Said Yes” We worked on improving communication
                and affection despite the miles between us. We spoke to our
                families, shared our intentions, and with their blessings, we
                embarked on a new chapter. Today, as we stand on the brink of
                forever, we reflect on our journey with gratitude. Our love has
                endured every challenge, and we are overjoyed to start this new
              ...
              <p
                data-aos="fade-up"
                className="mt-5 text-base text-gray-600 font-bold"
              >
                Here's to the beautiful life we are about to build together, the
                lessons learned, and the love that has brought us to this
                moment. True love is worth every hurdle along the way. #DANNEL
                2025
              </p>
            </div>
          </div>
